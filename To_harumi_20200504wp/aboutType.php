...
<div class="">
  <div class="jumbotron jumbotron-fluid typelab-wrapper">
    <h1 class="display-4 text-light">タイプとは</h1>
...
<div class="contents-wrapper">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        <h3 class="text-center">タイプとは？</h3>
      </div>
      <div class="col-11 col-md-8">
        <p>一流の多国籍企業は、従業員が最も貴重なリソースであるため、人々に投資する必要があることを知っています。
          <br>Forbesによると、タイプはフォーチュン100企業の80％で使用されており、より協力で効果的なチームを構築し、コミュニケーションとリーダーシップ開発を改善します。
          <br>タイプは、ほとんどすべての米国の大学で、学生が自分のやりがいのあるキャリアを特定できるように使用されています。多くの企業は、タイプを使用して新入社員のトレーニングを支援しています。
        </p>
      </div>
    </div>
</div>
...
<div class="contents-wrapper">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/img/type4character.png" width="100%">
      </div>
      <div class="col-11 col-md-8">
...
<div class="contents-wrapper">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/img/6b0c88c1f75c6c018d31feb0c7fb4524_s.jpg" width="100%">
      </div>
      <div class="col-11 col-md-8">
...
<div class="contents-wrapper">
    <div class="row justify-content-center">
      <div class="col-12 col-md-8">
        ...
        <img src="<?php echo get_template_directory_uri(); ?>/img/pic-member2.jpg" width="100%">
      </div>
      <div class="col-11 col-md-8">
        <p>16 Typeでは自分や他者を理解する最初の入り口として、4文字タイプ論を理解するための体験講習会「4文字タイプセッション」を定期的に開催しています。セッションの流れをご紹介します。</p>
        <ul>
